...
void dealCards(card* shuffled, card* stock, card* discard, player* p, int numOf);
         ...
         if (command == 1)
            {
         	...
         	{
         		//dealDeck 
         		dealCards(shuffledptr, stockptr, discardptr, playerptr, numOfPlayers);
         	}
         else if (command == 3)
            {
